...
// installed ginfer::Engine API; this file owns its CLI, matrix, statistics, and report schema.
...
inline constexpr std::string_view kArtifactType       = "ginfer_bench_report";
