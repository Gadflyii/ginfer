#!/usr/bin/env python3
"""Send one GInfer CLI messages file to an already-running ginfer-serve instance."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("messages", type=Path, help="GInfer CLI --messages JSON file")
