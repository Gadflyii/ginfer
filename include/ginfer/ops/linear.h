 ...
 * problems register the five Qwen non-vocabulary FP8 geometries plus the five Muse Glimmer
 * transformer geometries `[4096,6656]`, `[256,6656]`, `[6656,4096]`, `[19968,6656]`, and
 * `[6656,19968]`; all accept every positive T. Text and
