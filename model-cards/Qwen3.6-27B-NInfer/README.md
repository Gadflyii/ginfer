...
printf '%s  %s\n' \
  ...
  'qwen3_6_27b.ginfer' | sha256sum --check
```
...
- NVIDIA GeForce RTX 5090 or NVIDIA RTX PRO 6000 Blackwell (`sm_120a`); NVIDIA GeForce RTX 4090
  (`sm_89`) or RTX 3090 (`sm_86`) for this groupwise-int artifact only (24 GB envelope; no FP8,
  no NVFP4);
...
CUDA 13.1. Requests were submitted serially to a persistent `ginfer-serve` process with CUDA Graph
