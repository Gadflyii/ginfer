...
#define CUDA_CHECK(expr) ::ginfer::cuda_check((expr), #expr, __FILE__, __LINE__)
...
struct DeviceContext {
    ...
    [[nodiscard]] const GpuCapability& capability() const noexcept;
    [[nodiscard]] const OccupancyPolicy& occupancy() const noexcept;
