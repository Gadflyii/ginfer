...
void launch_nvfp4_w4a4_tma_linear(Nvfp4Problem problem, const std::uint8_t* activation_codes,
    ...
    case Nvfp4Problem::MuseQueryGate:
        launch_linear<Nvfp4MuseQueryGateGeometry>(activation_codes, activation_scales, weight_codes,
                                                  weight_scales, output, tokens, alpha, stream);
        return;
    case Nvfp4Problem::MuseKeyValue:
        launch_linear<Nvfp4MuseKeyValueGeometry>(activation_codes, activation_scales, weight_codes,
                                                 weight_scales, output, tokens, alpha, stream);
        return;
    case Nvfp4Problem::MuseAttnOut:
        launch_linear<Nvfp4MuseAttnOutGeometry>(activation_codes, activation_scales, weight_codes,
                                                weight_scales, output, tokens, alpha, stream);
        return;
    case Nvfp4Problem::MuseMlpIn:
        launch_linear<Nvfp4MuseMlpInGeometry>(activation_codes, activation_scales, weight_codes,
                                              weight_scales, output, tokens, alpha, stream);
        return;
    case Nvfp4Problem::MuseMlpOut:
        launch_linear<Nvfp4MuseMlpOutGeometry>(activation_codes, activation_scales, weight_codes,
                                               weight_scales, output, tokens, alpha, stream);
        return;
    }
}
