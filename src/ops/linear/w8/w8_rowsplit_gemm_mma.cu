...
#define GINFER_W8_MMA_LAUNCHER(Name, Schedule)                                                     \
    void Name(const Tensor& x, const Weight& w, Tensor& out, cudaStream_t stream) {                \
        launch_route<Schedule>(x, w, out, stream);                                                 \
    }

GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r32_c64, MmaR32C64)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r32_c96, MmaR32C96)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r32_c128, MmaR32C128)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r48_c64, MmaR48C64)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r48_c96, MmaR48C96)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r48_c112, MmaR48C112)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r48_c128, MmaR48C128)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r64_c96, MmaR64C96)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r64_c112, MmaR64C112)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r64_c128, MmaR64C128)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r96_c96, MmaR96C96)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r128_c64, MmaR128C64)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r128_c80, MmaR128C80)
GINFER_W8_MMA_LAUNCHER(launch_w8_mma_r64x16_c48_k128_a1, MmaR64x16C48K128A1)

#undef GINFER_W8_MMA_LAUNCHER

#define GINFER_W8_EXACT_LAUNCHER(Name, Prefix, TileCols)                                           \
    void Name(const Tensor& x, const Weight& w, Tensor& out, cudaStream_t stream) {                \
        launch_exact_tail<TileCols>(Prefix, x, w, out, stream);                                    \
    }

GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r32_c96, launch_w8_mma_r32_c96, 96)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r32_c128, launch_w8_mma_r32_c128, 128)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r48_c96, launch_w8_mma_r48_c96, 96)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r48_c128, launch_w8_mma_r48_c128, 128)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r64_c96, launch_w8_mma_r64_c96, 96)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r64_c128, launch_w8_mma_r64_c128, 128)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r96_c96, launch_w8_mma_r96_c96, 96)
GINFER_W8_EXACT_LAUNCHER(launch_w8_exact_mma_r128_c80, launch_w8_mma_r128_c80, 80)

#undef GINFER_W8_EXACT_LAUNCHER
