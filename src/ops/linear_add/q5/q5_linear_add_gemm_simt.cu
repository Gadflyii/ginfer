...
void dispatch_cols(std::int32_t cols, Launch&& launch) {
    switch (cols) {
#define GINFER_Q5_LINEAR_ADD_EXACT(COLS)                                                           \
    case COLS:                                                                                     \
        launch.template operator()<COLS>();                                                        \
        return
        GINFER_Q5_LINEAR_ADD_EXACT(2);
        GINFER_Q5_LINEAR_ADD_EXACT(3);
        GINFER_Q5_LINEAR_ADD_EXACT(4);
        GINFER_Q5_LINEAR_ADD_EXACT(5);
        GINFER_Q5_LINEAR_ADD_EXACT(6);
        GINFER_Q5_LINEAR_ADD_EXACT(7);
        GINFER_Q5_LINEAR_ADD_EXACT(8);
        GINFER_Q5_LINEAR_ADD_EXACT(9);
        GINFER_Q5_LINEAR_ADD_EXACT(10);
        GINFER_Q5_LINEAR_ADD_EXACT(11);
        GINFER_Q5_LINEAR_ADD_EXACT(12);
        GINFER_Q5_LINEAR_ADD_EXACT(13);
        GINFER_Q5_LINEAR_ADD_EXACT(14);
        GINFER_Q5_LINEAR_ADD_EXACT(15);
        GINFER_Q5_LINEAR_ADD_EXACT(16);
#undef GINFER_Q5_LINEAR_ADD_EXACT
    default:
