...
namespace ginfer::ops::detail::gated_delta_net::chunked::state_passing {

using ginfer::ops::mma_tf32_bits;
using ginfer::ops::ldmatrix_x2;
using ginfer::ops::ldmatrix_x2_t;
...
struct kernel_dims<16> {
    ...
    static constexpr int THREADS            = N_WARPS * ginfer::ops::kWarpSize;
