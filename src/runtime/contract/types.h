...
using ::ginfer::FinishReason;
using ::ginfer::KvCapacityMode;
using ::ginfer::KvCapacityPolicy;
using ::ginfer::OutputChannel;
using ::ginfer::ResolvedSamplingParameters;
using ::ginfer::StopPolicy;
using ::ginfer::StopString;
using ::ginfer::TokenId;
