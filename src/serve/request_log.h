...
inline constexpr const char* kRequestLogArtifactType = "ginfer_serve_request_log";
...
struct RequestLogContext {
    ...
    ginfer::PromptPreparationStats preparation;
};
...
public:
    ...
    void write_server_start(const ServeOptions& options,
                            const ginfer::ModelSamplingDefaults& sampling_defaults,
                            const std::string& public_model_id, const ginfer::LoadSummary& load,
                            const ginfer::MemorySummary& memory);
