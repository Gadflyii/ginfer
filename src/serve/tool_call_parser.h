...
// Incrementally publishes text that is provably outside a possible supported tool-call suffix.
// At terminal time, a valid tool response discards the buffered tool region;
// malformed/non-tool output flushes it verbatim.
