...
using detail::GINFER_QWEN36_RUNTIME_NS::Variant;
...
SequencePlan<Variant> SequencePlanner<Variant>::finalize(std::uint32_t main_page_groups) && {
    ...
    return SequencePlan<Variant>(detail::GINFER_QWEN36_RUNTIME_NS::finalize_sequence_plan_impl(
...
SequencePlanner<Variant> make_sequence_planner<Variant>(DeviceContext& device,
    ...
    return SequencePlanner<Variant>(detail::GINFER_QWEN36_RUNTIME_NS::make_sequence_planner_impl(
