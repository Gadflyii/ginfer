...
#ifndef GINFER_QWEN36_VARIANT
#    error "GINFER_QWEN36_VARIANT must name the complete exact Variant"
#endif
#ifndef GINFER_QWEN36_RUNTIME_NS
#    error "GINFER_QWEN36_RUNTIME_NS must be a unique identifier for this instantiation"
#endif

#include <ginfer/targets/qwen3_6/runtime.h>

namespace ginfer::targets::qwen3_6::detail::GINFER_QWEN36_RUNTIME_NS {

using Variant                        = GINFER_QWEN36_VARIANT;
