...
using ReusePath = ginfer::PrefixReusePath;
...
template <>
struct RequestBasePlanImpl<GINFER_QWEN36_VARIANT> {
...
template <>
struct RequestPlanImpl<GINFER_QWEN36_VARIANT> {
    runtime::RequestPlanSummary summary;
    GINFER_QWEN36_RUNTIME_NS::ReusePath reuse = GINFER_QWEN36_RUNTIME_NS::ReusePath::FullReset;
    std::uint32_t reuse_base                  = 0;
    GINFER_QWEN36_RUNTIME_NS::MtpBridgeMode mtp_bridge =
        GINFER_QWEN36_RUNTIME_NS::MtpBridgeMode::None;
    bool prepare_mtp = false;
    std::optional<GINFER_QWEN36_RUNTIME_NS::VisionPrefillPlan> vision;
    GINFER_QWEN36_RUNTIME_NS::RewriteCheckpointAction rewrite_checkpoint_action =
        GINFER_QWEN36_RUNTIME_NS::RewriteCheckpointAction::Drop;
...
struct PendingCandidate {
    ...
    std::uint32_t context_copy_extent = 0;
...
struct SequenceState {
    ...
    qwen3_6::detail::ContextCopyIndex context_copy;
    std::uint32_t context_copy_confirmations = 0;
...
public:
    ...
    const std::uint32_t dflash_target_window;
    ...
    std::optional<GdnReplayRecords> wide_replay_records;
    ...
    DecodeGraphFamily dflash_wide_graphs;
...
template <>
class ProgramImpl<GINFER_QWEN36_VARIANT> final : public GINFER_QWEN36_RUNTIME_NS::ProgramImplCore {
public:
    using GINFER_QWEN36_RUNTIME_NS::ProgramImplCore::ProgramImplCore;
};
