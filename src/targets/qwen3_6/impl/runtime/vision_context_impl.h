...
#include "ginfer/ops/add_bias.h"
#include "ginfer/ops/gelu.h"
#include "ginfer/ops/layer_norm.h"
...
#include "ginfer/ops/vision_pos_embed.h"
        ...
        const BlockW& block = blocks_[layer];
        {
            Tensor attended = layout.attended.bind(backing);
            {
                ...
                ops::rope(position_ids, VisionScheduleConfig::rotary_dim,
                          VisionScheduleConfig::rope_theta, q, k, ctx_.occupancy(), stream);
