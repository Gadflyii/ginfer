...
struct DFlashConfig {
    ...
    static constexpr bool sampled_dflash2  = true;
    static constexpr int layers            = 5;
    static constexpr int local_layers      = layers;
    ...
    static constexpr int kernel_projection_rows =
        2 * conv_kernel * hidden / conv_group;
