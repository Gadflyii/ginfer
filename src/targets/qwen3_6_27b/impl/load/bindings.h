...
#include <ginfer/targets/qwen3_6/model_view.h>
...
struct DFlash2LayerPlan {
    ...
    WeightPlan attention_conv_proj;
    WeightPlan post_attention_layernorm;
    WeightPlan mlp_gate;
    WeightPlan mlp_up;
    WeightPlan mlp_down;
    WeightPlan mlp_conv_base;
    WeightPlan mlp_conv_proj;
};

struct DFlash2Plan {
    WeightPlan feature_projection;
    WeightPlan hidden_norm;
...
using RuntimeModelView =
    qwen3_6::ModelView<FullAttentionProjectionPayload, GdnProjectionPayload, DensePostMixerPayload,
                       ...
                       qwen3_6::DFlash2Weights<kDFlash2Layers>,
