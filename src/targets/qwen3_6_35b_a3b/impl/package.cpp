...
namespace ginfer::targets::qwen3_6_35b_a3b {
namespace {
...
GpuRequirements Package::gpu_requirements(WeightsProfile weights_profile,
    ...
    if (weights_profile != WeightsProfile::GroupwiseInt) {
        throw std::logic_error("invalid Qwen3.6-35B-A3B weight profile");
    }
    const bool dflash = options.speculative.backend == SpeculativeBackend::DFlash;
    return {.sm_86 = !dflash, .sm_89 = !dflash, .sm_120 = true, .nvfp4 = false};
}
