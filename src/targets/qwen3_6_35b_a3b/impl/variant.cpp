...
#include "ginfer/ops/sparse_moe.h"

#include <algorithm>
#include <stdexcept>

#define GINFER_QWEN36_VARIANT    ::ginfer::targets::qwen3_6_35b_a3b::detail::Variant
#define GINFER_QWEN36_RUNTIME_NS qwen3_6_35b_a3b_runtime
#include "targets/qwen3_6/impl/runtime/instantiate.h"

namespace ginfer::targets::qwen3_6_35b_a3b::detail {
namespace {
...
void run_sparse_moe(const Tensor& hidden, const ops::SparseMoeWeights& weights, Tensor& residual,
                    WorkspaceArena& workspace, const OccupancyPolicy& occupancy,
                    cudaStream_t stream) {
...
void Variant::gdn_norm_control_projection(const Tensor& residual, const Tensor& norm_weight,
    ...
    ops::gdn_norm_gating_proj(residual, norm_weight, eps, weights.a_b_projection, weights.a_log,
                              weights.dt_bias, workspace, hidden, g, beta, occupancy, stream);
}

void Variant::post_mixer(const Tensor& hidden, const PostMixerWeights& weights, Tensor& residual,
                         qwen3_6::TextPhase, WorkspaceArena& workspace,
                         const OccupancyPolicy& occupancy, cudaStream_t stream) {
    run_sparse_moe(hidden, weights.op, residual, workspace, occupancy, stream);
}
