...
int q4_a16_conformance() {
    ...
    constexpr std::array kDFlashSmallT{
        a16(1), a16(4), a16(5), a16(8), a16(9), a16(15), a16(16), a16(17),
    };
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {256, 5120, 102U, Comparison::Sampled, false, kDFlashSmallT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {1280, 5120, 104U, Comparison::Sampled, false, kDFlashSmallT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {17408, 5120, 105U, Comparison::Sampled, false, kDFlashSmallT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {5120, 4096, 106U, Comparison::Sampled, false, kDFlashSmallT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {5120, 17408, 108U, Comparison::Sampled, false, kDFlashSmallT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {5120, 25600, 110U, Comparison::Sampled, false, kDFlashSmallT});
    ...
    constexpr std::array kMuseSampledT{
        a16(1),  a16(2),  a16(7),  a16(8),  a16(9),   a16(15),  a16(16),
        a16(17), a16(32), a16(64), a16(120), a16(128),
    };
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {256, 6656, 149U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {4096, 6656, 151U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {6656, 4096, 157U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {6656, 6656, 163U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {19968, 6656, 167U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {6656, 19968, 173U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {1024, 6656, 179U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {1664, 6656, 180U, Comparison::Sampled, false, kMuseSampledT});
    failures += run_shape("Q4_A16", ActivationCompute::A16, make_q4g64_f16s_weight,
                          {6656, 33280, 181U, Comparison::Sampled, false, kMuseSampledT});
