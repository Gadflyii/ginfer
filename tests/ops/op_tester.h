...
#include "core/tensor.h" // ginfer::DType, ginfer::Tensor (for op call sites)
...
inline const OccupancyPolicy& test_occupancy() {
...
inline bool error_stats_enabled() {
    static const bool enabled = [] {
        const char* value = std::getenv("GINFER_OP_REPORT_STATS");
