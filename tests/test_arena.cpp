...
int main() {
    ...
    ginfer::DeviceBuffer buffer(host_source.size());
    ...
    ginfer::DeviceBuffer moved_buffer(std::move(buffer));
    ...
    ginfer::Tensor a = arena.alloc(ginfer::DType::BF16, {3, 5});
    ...
    ginfer::Tensor b = arena.alloc(ginfer::DType::U8, {17}, 64);
    ...
    std::size_t peak_after_transient    = 0;
    {
        ...
        ginfer::Tensor transient = arena.alloc(ginfer::DType::U8, {11}, 128);
        ...
        }
        {
            ...
            (void)arena.alloc(ginfer::DType::U8, {7}, 64);
        }
    ...
    ginfer::Tensor reused = arena.alloc(ginfer::DType::U8, {5}, 128);
    ...
    failures += expect_throws<std::runtime_error>(
        [&] {
            ...
            (void)arena.alloc(ginfer::DType::U8, {9}, 64);
    ...
    failures += expect_throws<std::bad_alloc>(
        [&] { (void)arena.alloc(ginfer::DType::FP32, {300}, 256); }, "arena oom");
    ...
    ginfer::Tensor c = arena.alloc(ginfer::DType::U8, {4});
    ...
    ginfer::DeviceArena moved(std::move(arena));
    ...
    {
        ginfer::DeviceArena borrowed(ginfer::DeviceSpan{external, 512});
        ...
        const ginfer::Tensor item = borrowed.alloc(ginfer::DType::U8, {17}, 64);
    ...
    ginfer::PinnedHostBuffer pinned(128);
