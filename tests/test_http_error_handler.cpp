...
using ginfer::serve::ServeOptions;
...
int main() {
    ...
    const ginfer::serve::ApiError media_budget = ginfer::serve::request_error_to_api_error(
        ginfer::RequestError(ginfer::RequestErrorKind::MediaBudgetExceeded,
    ...
    const ginfer::serve::ApiError context_limit = ginfer::serve::request_error_to_api_error(
        ginfer::RequestError(ginfer::RequestErrorKind::ContextLengthExceeded,
    ...
    const ginfer::serve::ApiError cancelled =
        ginfer::serve::request_error_to_api_error(ginfer::RequestError(
            ginfer::RequestErrorKind::Cancelled, "request cancelled during preparation"));
    ...
    const auto messages_result =
        ginfer::serve::handle_unrendered_http_error(options, messages_request, messages_response);
    ...
    const auto openai_result =
        ginfer::serve::handle_unrendered_http_error(options, openai_request, openai_response);
    ...
    const auto authored_result =
        ginfer::serve::handle_unrendered_http_error(options, openai_request, authored_response);
    ...
    const auto other_result =
        ginfer::serve::handle_unrendered_http_error(options, openai_request, other_response);
