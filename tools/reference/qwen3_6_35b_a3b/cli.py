"""Command-line reference inference for the Qwen3.6-35B-A3B GInfer artifact."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--weights", required=True, help="Qwen3.6-35B-A3B .ginfer artifact")
...
def _validate_args(parser: argparse.ArgumentParser, args: argparse.Namespace) -> None:
    if Path(args.weights).suffix != ".ginfer":
        parser.error("--weights must name a .ginfer artifact")
    if args.decode < 0:
